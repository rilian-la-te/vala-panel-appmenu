...
namespace GLib {
	...
	public class DesktopAppInfo : GLib.Object, GLib.AppInfo {
		...
		public bool launch_uris_as_manager (GLib.List? uris, GLib.AppLaunchContext launch_context, GLib.SpawnFlags spawn_flags, GLib.SpawnChildSetupFunc user_setup,GLib.DesktopAppLaunchCallback pid_callback) throws GLib.Error;
